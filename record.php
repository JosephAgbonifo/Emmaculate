...
if (mysqli_query($conn, $sqil)) {
  ...
  $studentes=$student.'/'.$gsess.'/'.$gterm;
    ...
    $tc=[];
    $pc=[];
     $sqll="SELECT fullname, class,sex,tc, pc, img FROM students WHERE reg_number='$student'";
...
STUDENT WITH THE PROVIDED CODE DOES NOT EXIST <br > PLS, CHECK CODE AND TRY AGAIN.
 ...
 <i class="fa-solid fa-envelope"></i> emmaculatecollege19@gmail.com
     ...
     <strong><h5 class="mt-2 text-warning">EXAMINATION RESULT SHEET  </h5></strong>
   </div>
      <div class="col-3">
  ...
  <h5 class="float-end"><strong>STATUS: </strong> <span style='backgroundcolor:green'>DONE</span></span> </h5>
  <br />
    ...
    <h6 ><strong>SESSION : </strong><?php echo $gsess ; ?>        </h6>
      ...
      <div class='col'>
        <h6><strong>TERM : </strong><?php echo $gter ;?> </h6>
      </div>
    </div>
    <h6>NEXT TERM BEGINS :22<sup>nd</sup>April 2024 </h6>
    </div><
    <form action="<?php echo "fetchreport.php" ?>" method="post">
    <?php 
    include 'table.php';
    ?>
  ...
  <?php 
      include "com.php";
      ?>
   <div style="width:80%; text-align:left" class="container-fluid m-auto mt-1 row">
